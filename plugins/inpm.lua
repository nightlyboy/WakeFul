...
local name_log = user_print_name(msg.from)
	...
	if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = "Welcome to Robot!\n\nThis is a bot run by @n_boy for managing the official group @WakeFulAntiSpam on Telegram\n\nCheck out our channel @wakeful_antispam\n\nAlso join To Group Support\n\nhttps://telegram.me/joinchat/D8FC5wlovPm0lJ00UMQSHA for knowing more!"
     	return text
    end
